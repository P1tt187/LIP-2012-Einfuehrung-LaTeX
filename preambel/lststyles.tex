...
\newcommand{\lstsettex}{
 \lstset{language=TeX,
        ...
        %%linewidth=\textwidth,captionpos=b
        numbers=left,
        morekeywords={\usepackage,\documentclass,\title,\author,\date,\today,\begin,\end,\section,\maketitle,\tableofcontents,\subsection,\LaTeX,\textbf,\textit,\listoffigures,\listoftables,\lstlistoflistings,\includegraphics,\caption,\linewidth,\label,\hline, &}
 }
}
