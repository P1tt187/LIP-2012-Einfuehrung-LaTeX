...
\newcommand{\lstsettex}{
 \lstset{language=TeX,
        ...
        float=htpb,
        rulesepcolor=\color{black},
        commentstyle=\tiny\color{sh_comment}\textit,
        keywordstyle=\tiny\color{sh_keyword}\bfseries,
        basicstyle=\tiny\ttfamily,
        stringstyle=\tiny\color{sh_string}\ttfamily,
        showstringspaces=false,
        frame=single,
        tabsize=2,
        ...
        %%linewidth=\textwidth,captionpos=b
        numbers=left,
        morekeywords={\usepackage,\documentclass,\title,\author,\date,\today,\begin,\end,\section,\maketitle,\tableofcontents,\subsection,\LaTeX,\textbf,\textit,\listoffigures,\listoftables,\lstlistoflistings,\includegraphics,\caption,\linewidth,\label,\hline, &,\draw,\bibliography,\cite,\footcite,\printbibliography,\node,\path,\foreach,\ifthenelse,\isodd,\textwidth}
 }
}
